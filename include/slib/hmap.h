...
/* Adjusting capacity. */
void hmap_expand_at(struct hmap *);
#define hmap_expand(HMAP) hmap_expand_at(HMAP)

void hmap_shrink_at(struct hmap *);
#define hmap_shrink(HMAP) hmap_shrink_at(HMAP)

void hmap_reserve_at(struct hmap *, size_t capacity);
#define hmap_reserve(HMAP, CAPACITY) \
    hmap_reserve_at(HMAP, CAPACITY)

/* Insertion and deletion. */
static inline void hmap_insert_at(struct hmap *, struct hmap_node *,
                                  size_t hash);
#define hmap_insert(HMAP, NODE, HASH) \
    hmap_insert_at(HMAP, NODE, HASH)
